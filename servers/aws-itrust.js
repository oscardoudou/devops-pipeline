...
var allocationId;
var securityGroup = {
    Description: 'SecurityGroupforItrust', 
    GroupName: 'Itrust', 
    DryRun: false
}
var keyPairName = {
...
EC2.describeKeyPairs(keyName, function(err, data) {
    if (err) {
        console.log('\n Unable to describe KeyPair "Itrust", creating a new KeyPair') 
                                    ...
                                    if(err) 
                                        ...
                                        EC2.associateAddress(associateAddressParams, function(err, data) {
                                            if(err)
                                                ...
                                                var filePath = process.env.HOME + '/iTrust2-v4/iTrust.pem'
                                                ...
                                                var inventoryData = '[itrust]\n' + publicIpAddress + ' ansible_ssh_user=ubuntu' + ' ansible_ssh_private_key_file=/home/ubuntu/iTrust2-v4/iTrust.pem' + ' ansible_python_interpreter=/usr/bin/python3'
                                                fs.writeFile('/home/ubuntu/inventory_iTrust', inventoryData, function(err) {
